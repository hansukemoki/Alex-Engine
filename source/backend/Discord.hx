...
class DiscordClient
{
	...
	private inline static final _defaultID:String = "1403012359013928980";
	...
	public static function changePresence(details:String = 'is playing Alex Engine', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
